...
const DUMMY_DATA = [
  {
    id: 1,
    noSurat: '422.1/005/SD-01/VII/2026',
    tanggal: '2026-07-05',
    ...
    tanggalSuratPermohonan: '2026-07-01',
    sekolahTujuan: 'SD Negeri 2 Kedawung',
    alamatSekolahTujuan: 'Kecamatan Kedawung, Kabupaten Cirebon',
    alasanMutasi: 'Ikut Orang Tua',
    status: 'Aktif',
  },
  {
    id: 2,
    noSurat: '422.1/006/SD-01/VII/2026',
    tanggal: '2026-07-06',
    ...
    kelas: 'VI',
    namaOrtu: 'Asep Supriatna',
    tanggalSuratPermohonan: '2026-07-02',
    sekolahTujuan: 'MI Muhammadiyah 1',
    alamatSekolahTujuan: 'Kecamatan Kuningan, Kabupaten Kuningan',
    alasanMutasi: 'Domisili',
    status: 'Aktif',
  },
];

export default function SiswaMutasi() {
    ...
    <div className="w-full h-full flex flex-col space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Kelola dan cetak Surat Keterangan Mutasi Siswa.</p>
        </div>
            ...
            >
              <div className="flex items-center justify-between p-4 md:p-6 border-b border-white/10 shrink-0 bg-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-white">{isEditMode ? 'Edit Surat Keterangan Mutasi' : 'Buat Surat Keterangan Baru'}</h2>
                    <p className="text-xs text-slate-400 mt-0.5">Lengkapi data untuk surat keterangan mutasi siswa</p>
                  </div>
                </div>
                <button 
                  onClick={() => setIsModalOpen(false)}
              ...
              <div className="p-4 md:p-6 custom-scrollbar overflow-y-auto space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5 sm:col-span-2">
                    ...
                    <input type="text" value={formData.noSurat || ''} onChange={(e) => handleFormChange('noSurat', e.target.value)} placeholder="Contoh: 422.1/005/SD-01/VII/2026" className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-all" />
                  </div>
                      ...
                      onChange={(e) => {
                        ...
                        if (selected) {
                          setFormData({
                            ...
                            namaOrtu: selected.namaAyah || selected.namaIbu || selected.namaWali || ''
                          });
                        }
                      }}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="text" value={formData.tempatLahir || ''} onChange={(e) => handleFormChange('tempatLahir', e.target.value)} placeholder="Contoh: Cirebon" className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-all" />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-slate-300">Tanggal Lahir</label>
                    <input type="date" value={formData.tanggalLahir || ''} onChange={(e) => handleFormChange('tanggalLahir', e.target.value)} className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-blue-500 transition-all [color-scheme:dark]" />
                  </div>
                  <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-slate-300">Tingkat / Kelas</label>
                    <input type="text" value={formData.kelas || ''} onChange={(e) => handleFormChange('kelas', e.target.value)} placeholder="Contoh: V" className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-all" />
                  </div>
                  
                  <div className="sm:col-span-2 pt-2 border-t border-white/10 mt-2">
                    <h3 className="text-sm font-medium text-white mb-3">Data Kepindahan</h3>
                  </div>
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-sm font-medium text-slate-300">Nama Orang Tua / Wali</label>
                    <input type="text" value={formData.namaOrtu || ''} onChange={(e) => handleFormChange('namaOrtu', e.target.value)} placeholder="Masukkan nama orang tua/wali" className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-all" />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-slate-300">Tanggal Surat Permohonan</label>
                    <input type="date" value={formData.tanggalSuratPermohonan || ''} onChange={(e) => handleFormChange('tanggalSuratPermohonan', e.target.value)} className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-blue-500 transition-all [color-scheme:dark]" />
                  </div>
                  <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-sm font-medium text-slate-300">Sekolah Tujuan</label>
                    <input type="text" value={formData.sekolahTujuan || ''} onChange={(e) => handleFormChange('sekolahTujuan', e.target.value)} placeholder="Contoh: SD Negeri 2 Kedawung" className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-all" />
                  </div>
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-sm font-medium text-slate-300">Alamat Sekolah Tujuan</label>
                    <input type="text" value={formData.alamatSekolahTujuan || ''} onChange={(e) => handleFormChange('alamatSekolahTujuan', e.target.value)} placeholder="Contoh: Kecamatan Kedawung, Kabupaten Cirebon" className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-all" />
                  </div>
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-sm font-medium text-slate-300">Alasan Pindah / Mutasi</label>
                    <input type="text" value={formData.alasanMutasi || ''} onChange={(e) => handleFormChange('alasanMutasi', e.target.value)} placeholder="Contoh: Ikut Orang Tua" className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500 transition-all" />
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-white flex justify-center overflow-y-auto max-h-[70vh] custom-scrollbar">
                <div id="sk-print-area" className="bg-white text-black p-10 font-serif mx-auto" style={{ width: '215.9mm', minHeight: '330.2mm', maxWidth: '100%', boxSizing: 'border-box' }}>
                  ...
                  <div className="text-center mb-10">
                    <h3 className="font-bold text-xl underline leading-tight">SURAT KETERANGAN PINDAH SEKOLAH</h3>
                    <p className="font-bold mt-1">Nomor: {selectedData.noSurat}</p>
                  </div>

                  <div className="mb-8 text-justify text-[16px] leading-relaxed">
                    <p className="mb-4">
                      Yang bertanda tangan di bawah ini, Kepala {kopSurat.kopBaris3}, menerangkan bahwa siswa di bawah ini:
                    </p>
                    <table className="w-full ml-8 mb-4">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="py-1">{selectedData.nis}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="py-1">:</td>
                          <td className="py-1">{selectedData.tempatLahir}, {new Date(selectedData.tanggalLahir).toLocaleDateString('id-ID', { year: 'numeric', month: 'long', day: 'numeric' })}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td className="py-1">Tingkat / Kelas</td>
                          <td className="py-1">:</td>
                        ...
                        <tr>
                          ...
                          <td className="py-1">:</td>
                          <td className="py-1">{selectedData.namaOrtu}</td>
                        </tr>
                      </tbody>
                    </table>

                    <p className="mb-4">
                      Sesuai dengan Surat Permohonan Pindah Sekolah oleh Orang Tua / Wali murid tanggal {selectedData.tanggalSuratPermohonan ? new Date(selectedData.tanggalSuratPermohonan).toLocaleDateString('id-ID', { year: 'numeric', month: 'long', day: 'numeric' }) : '[Tanggal Surat Permohonan]'}, yang bersangkutan mengajukan permohonan pindah (mutasi) ke sekolah:
                    </p>
                    
                    <table className="w-full ml-8 mb-4">
                      <tbody>
                        <tr>
                          <td className="w-56 py-1">Nama Sekolah Tujuan</td>
                          <td className="w-4 py-1">:</td>
                          <td className="font-bold py-1">{selectedData.sekolahTujuan}</td>
                        </tr>
                        <tr>
                          <td className="py-1">Alamat Sekolah Tujuan</td>
                          <td className="py-1">:</td>
                          <td className="py-1">{selectedData.alamatSekolahTujuan}</td>
                        </tr>
                        <tr>
                          <td className="py-1">Alasan Pindah</td>
                          <td className="py-1">:</td>
                          <td className="py-1">{selectedData.alasanMutasi}</td>
                        </tr>
                      </tbody>
                    </table>

                    <p className="mb-4">
                      Bersama ini kami lampirkan Buku Laporan Hasil Belajar Siswa (Rapor) yang bersangkutan. Sejak
                      tanggal dikeluarkannya surat ini, siswa tersebut dinyatakan <span className="font-bold">telah keluar</span> dari {kopSurat.kopBaris3}.
                    </p>
                  ...
                  <div className="flex justify-between mt-12">
                    <div className="w-64 text-[16px] text-center">
                      <div className="mb-24 mt-6">Orang Tua / Wali Siswa,</div>
                      
                      <div className="font-bold border-b border-black pb-0.5 inline-block min-w-full">
                        {selectedData.namaOrtu || '............................................................'}
                      </div>
                    </div>
                  ...
                  <div className="mt-8 pt-4 border-t border-dashed border-gray-400 text-sm">
                    <p className="font-bold mb-1">Catatan:</p>
                    <p>* Surat keterangan mutasi ini baru dianggap sah/berlaku apabila telah mendapatkan Surat Rekomendasi Menerima dari Sekolah Tujuan serta validasi dari Dinas Pendidikan setempat.</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            >
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-white text-center mb-2">Hapus Surat Mutasi</h3>
                <p className="text-slate-400 text-center text-sm mb-6">
                  Apakah Anda yakin ingin menghapus surat keterangan mutasi ini? Tindakan ini tidak dapat dibatalkan.
                </p>
